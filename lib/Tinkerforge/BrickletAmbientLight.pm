...
=cut
    ...
    my $self :shared = shared_clone({super => shared_clone(Tinkerforge::Device->new($uid, $ipcon)),
                                     api_version => [2, 0, 0],
                                     response_expected => shared_clone({&FUNCTION_GET_ILLUMINANCE => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        &FUNCTION_GET_ANALOG_VALUE => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        &FUNCTION_SET_ILLUMINANCE_CALLBACK_PERIOD => Tinkerforge::Device->RESPONSE_EXPECTED_TRUE,
                                                                        &FUNCTION_GET_ILLUMINANCE_CALLBACK_PERIOD => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        ...
                                                                        &FUNCTION_SET_ILLUMINANCE_CALLBACK_THRESHOLD => Tinkerforge::Device->RESPONSE_EXPECTED_TRUE,
                                                                        &FUNCTION_GET_ILLUMINANCE_CALLBACK_THRESHOLD => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        ...
                                                                        &CALLBACK_ILLUMINANCE => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_FALSE,
                                                                        &CALLBACK_ANALOG_VALUE => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_FALSE,
                                                                        &CALLBACK_ILLUMINANCE_REACHED => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_FALSE,
                                    ...
                                    callback_formats => shared_clone({&CALLBACK_ILLUMINANCE => 'S',
                                                                      &CALLBACK_ANALOG_VALUE => 'S',
                                                                      &CALLBACK_ILLUMINANCE_REACHED => 'S',
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_ILLUMINANCE, [], '', 'S');
}
...
=cut
    ...
    $self->{super}->send_request($self, &FUNCTION_SET_ILLUMINANCE_CALLBACK_PERIOD, [$period], 'L', '');
}
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_ILLUMINANCE_CALLBACK_PERIOD, [], '', 'L');
}
...
=cut
    ...
    $self->{super}->send_request($self, &FUNCTION_SET_ILLUMINANCE_CALLBACK_THRESHOLD, [$option, $min, $max], 'a s s', '');
}
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_ILLUMINANCE_CALLBACK_THRESHOLD, [], '', 'a s s');
 }
