...
=cut
    ...
    my $self :shared = shared_clone({super => shared_clone(Tinkerforge::Device->new($uid, $ipcon)),
                                     api_version => [2, 0, 0],
                                     response_expected => shared_clone({&FUNCTION_GET_MOISTURE_VALUE => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        &FUNCTION_SET_MOISTURE_CALLBACK_PERIOD => Tinkerforge::Device->RESPONSE_EXPECTED_TRUE,
                                                                        &FUNCTION_GET_MOISTURE_CALLBACK_PERIOD => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        &FUNCTION_SET_MOISTURE_CALLBACK_THRESHOLD => Tinkerforge::Device->RESPONSE_EXPECTED_TRUE,
                                                                        &FUNCTION_GET_MOISTURE_CALLBACK_THRESHOLD => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        ...
                                                                        &CALLBACK_MOISTURE => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_FALSE,
                                                                        &CALLBACK_MOISTURE_REACHED => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_FALSE,
                                    ...
                                    callback_formats => shared_clone({&CALLBACK_MOISTURE => 'S',
                                                                      &CALLBACK_MOISTURE_REACHED => 'S'})});
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_MOISTURE_VALUE, [], '', 'S');
}
...
=cut
    ...
    $self->{super}->send_request($self, &FUNCTION_SET_MOISTURE_CALLBACK_PERIOD, [$period], 'L', '');
}
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_MOISTURE_CALLBACK_PERIOD, [], '', 'L');
}
...
=cut
    ...
    $self->{super}->send_request($self, &FUNCTION_SET_MOISTURE_CALLBACK_THRESHOLD, [$option, $min, $max], 'a S S', '');
}
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_MOISTURE_CALLBACK_THRESHOLD, [], '', 'a S S');
 }
