...
=cut
    ...
    my $self :shared = shared_clone({super => shared_clone(Tinkerforge::Device->new($uid, $ipcon)),
                                     api_version => [2, 0, 0],
                                     response_expected => shared_clone({&FUNCTION_GET_INTENSITY => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        &FUNCTION_SET_INTENSITY_CALLBACK_PERIOD => Tinkerforge::Device->RESPONSE_EXPECTED_TRUE,
                                                                        &FUNCTION_GET_INTENSITY_CALLBACK_PERIOD => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        &FUNCTION_SET_INTENSITY_CALLBACK_THRESHOLD => Tinkerforge::Device->RESPONSE_EXPECTED_TRUE,
                                                                        &FUNCTION_GET_INTENSITY_CALLBACK_THRESHOLD => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE,
                                                                        ...
                                                                        &CALLBACK_INTENSITY => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_FALSE,
                                                                        &CALLBACK_INTENSITY_REACHED => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_FALSE,
                                                                        &FUNCTION_GET_IDENTITY => Tinkerforge::Device->RESPONSE_EXPECTED_ALWAYS_TRUE}),
                                    callback_formats => shared_clone({&CALLBACK_INTENSITY => 'S',
                                                                      &CALLBACK_INTENSITY_REACHED => 'S'})});
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_INTENSITY, [], '', 'S');
}
...
=cut
    ...
    $self->{super}->send_request($self, &FUNCTION_SET_INTENSITY_CALLBACK_PERIOD, [$period], 'L', '');
}
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_INTENSITY_CALLBACK_PERIOD, [], '', 'L');
}
...
=cut
    ...
    $self->{super}->send_request($self, &FUNCTION_SET_INTENSITY_CALLBACK_THRESHOLD, [$option, $min, $max], 'a S S', '');
}
...
=cut
    ...
    return $self->{super}->send_request($self, &FUNCTION_GET_INTENSITY_CALLBACK_THRESHOLD, [], '', 'a S S');
 }
